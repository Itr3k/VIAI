...
const AIAnalyst: React.FC<AIAnalystProps> = ({ userRole }) => {
    ...
    return (
        <div className="flex flex-col h-[calc(100vh-180px)] bg-white rounded-xl border border-slate-200 shadow-sm overflow-hidden">
